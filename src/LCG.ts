...
*/
const MODULUS = 18_446_744_073_709_551_616n as const; // m => A prime number (2^16+1)
const MULTIPLIER = 6_364_136_223_846_793_005n as const; // a => Primitive root modulo

// c => Setting c = 0 makes this a Multiplicative Congruential Generator (MCG)
const INCREMENT = 1_442_695_040_888_963_407n as const;
